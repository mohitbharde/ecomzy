...
const Product = ({ post }) => {
  ...
  return (
    <div className="group flex flex-col items-center justify-between hover:scale-110 hover:shadow-[0px_0px_95px_53px_#00000024]  transition duration-300  ease-in gap-3 p-4 mt-10 ml-5 rounded-xl ">
      <div>
